...
def main():
    ...
    imgTestingNumbers = cv2.imread("testData/syc.jpg")  # read in testing numbers image
    ...
    for contourWithData in validContoursWithData:  # for each contour
        ...
        #test.append('MlellMeAboutYourself')
        strFinalString = strFinalString + strCurrentChar  # append current char to full string

    # end for

    #test.append('M''lellMeAboutYourself')
    print("\n" + strFinalString + "\n")  # show the full string
    #test = "MlellMeAboutYourself"
    cv2.imshow("imgTestingNumbers", imgTestingNumbers)  # show input image with green boxes drawn around found digits
    cv2.waitKey(0)  # wait for user key press
    #print(metrics.accuracy_score(test, strFinalString))
